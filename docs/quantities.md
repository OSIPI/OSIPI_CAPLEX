...
| -- | -- | -- | -- | -- | -- | -- |
| Q.MS1.001.[j] | <a id="S" href="#S"></a>Signal <button class="md-button" onClick={() => CopyToClipboard(document.getElementById('Signal').href)}}">HYPERLINK</button> | -- | *S<sub>j</sub>* | The MR signal (magnitude, phase or complex depending on context) in compartment *j*. | a.u. | -- |
